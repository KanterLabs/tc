...
- Project task listing supports state, column, priority, label, assignee, and
  update-time filters.
...
task, claim, comment, and completion changes. Webhooks and streaming transports
are deferred until there is a demonstrated need.
